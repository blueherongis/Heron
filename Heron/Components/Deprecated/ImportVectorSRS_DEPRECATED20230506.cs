...
namespace Heron
{
    public class ImportVectorSRS_DEPRECATED20230506_OBSOLETE : HeronComponent
    {
        //Class Constructor
        public ImportVectorSRS_DEPRECATED20230506_OBSOLETE() : base("Import Vector", "ImportVector", "Import vector GIS data clipped to a boundary, including SHP, GeoJSON, OSM, KML, MVT and GDB folders.  " +
            "Use the SetSRS component to set the spatial reference system used by this component.", "GIS Import | Export")
        {

        }

        ///Retiring this component to add multiple source file inputs 
