...
namespace Heron
{
    public class ExportVector_DEPRECATED20240729_OBSOLETE : HeronComponent
    {
        /// <summary>
        /// Initializes a new instance of the ExportVector class.
        /// </summary>
        public ExportVector_DEPRECATED20240729_OBSOLETE()
        ...
        ///Retiring this component to add field types and convert closed lines to polygons option 
