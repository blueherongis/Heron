...
namespace Heron
{
    public class ImportVectorLite_DEPRECATED20250216_OBSOLETE : HeronComponent
    {
        //Class Constructor
        public ImportVectorLite_DEPRECATED20250216_OBSOLETE() : base("Import Vector Lite", "IVL", "This is a basic version of the Import Vector component " +
