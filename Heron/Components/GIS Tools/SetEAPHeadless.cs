...
namespace Heron
{
    public class SetEAPHeadless : HeronComponent
    {
        //Class Constructor
        public SetEAPHeadless() : base("Set Headless EarthAnchorPoint", "SetEAP", "Set the Rhino EarthAnchorPoint using either an address or Lat/Lon coordinates", "GIS Tools")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            */
            ...
            if (EAP == true)
            {
                ...
                //set new EAP
                HeadlessDoc.headlessDoc.EarthAnchorPoint = ePt;

                //new EAP to string for output
                lonlatString = addressString + "Longitude: " + HeadlessDoc.headlessDoc.EarthAnchorPoint.EarthBasepointLongitude.ToString() +
                " / Latitude: " + HeadlessDoc.headlessDoc.EarthAnchorPoint.EarthBasepointLatitude.ToString();
            }
        ...
        {
            get { return new Guid("4319e02c-106a-4bab-8b15-86f720f044c6"); }
        }
    }
}
