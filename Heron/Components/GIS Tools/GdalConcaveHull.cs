...
{
    public class GdalConcaveHull : HeronComponent
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public GdalConcaveHull()
          : base("Gdal Concave Hull", "GCCH",
              "Create a concave hull around geometry using Gdal's concave hull function.  GDAL concave hull only works in 2D, so the results will be on the XY plane.",
              "GIS Tools")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Ratio", "R", "Ratio of the area of the convex hull and the concave hull. A value of 1 will result in the convex hull.", GH_ParamAccess.tree);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            GH_Structure<GH_Number> ratios = new GH_Structure<GH_Number>();
            DA.GetDataTree<GH_Number>("Ratio", out ratios);
            ...
            for (int a = 0; a < gGoo.Branches.Count; a++)
            {
                ...
                var ratioList = ratios.Branches[a];
                GH_Convert.ToDouble(ratioList[0], out double ratio, GH_Conversion.Primary);
                ...
                ///Need to wait until GEOS 3.11 is included with the GDAL nuget package
                var hullCol = geoCollection.ConcaveHull(ratio,true);
        ...
        {
            get { return new Guid("C56FC98A-98DA-49F8-8621-8677E4520D90"); }
        }
    }
}